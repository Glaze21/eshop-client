            ...
            <div>
                ...
                <div className="right-container">
                    <div className="amount-container">
                        <img src="/plus-square.svg" onClick={() => onHandleAmount(item, true)} alt="+" />
                        <p>{item.amount}</p>
                        <img src="/minus-square.svg" onClick={() => onHandleAmount(item, false)} alt="-" />
                    </div>
                    <div className="img-container">
                        <img src={item.gallery[currentImg]} alt="" />
                        {item.gallery.length > 1 && (
                            <>
                                <img className="arrow-right" src="img-arrow.svg" alt="" onClick={() => handleImgChange(true)} />
                                <img className="arrow-left" src="img-arrow.svg" alt="" onClick={() => handleImgChange(false)} />
                            </>
                        )}
                    </div>
                </div>
