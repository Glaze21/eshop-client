...
//         if (_item.id === item.id && JSON.stringify(_item.selectedAttributes) === JSON.stringify(item.selectedAttributes)) {
//             _item.amount += 1;
//             newItem = false;
//         }
...
//     getState().root.cart.forEach((_item) => {
//         if (_item.id === oldItem.id && JSON.stringify(_item.selectedAttributes) === JSON.stringify(oldItem.selectedAttributes)) {
//             if (!obj.isDuplicate) {
//                 data.push(newItem);
//             }
//         } else {
...
//     var multipleItemArr = [];
//     cart.forEach((_item) => {
//         if (_item.id === newItem.id && JSON.stringify(_item.selectedAttributes) === JSON.stringify(newItem.selectedAttributes)) {
